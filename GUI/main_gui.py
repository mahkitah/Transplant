...
class MainGui(QWidget):
    ...
    def ui_main_layout(self):
        ...
        buttons_job.addWidget(self.pb_crop)
        ...
        right_top.addWidget(self.pb_scan)
        right_top.addWidget(self.tb_open_config2)
        ...
        view_n_buttons.addWidget(self.tabs, 1, 0, 1, 2)
        view_n_buttons.addLayout(self.view_stack, 2, 0, 1, 2)
